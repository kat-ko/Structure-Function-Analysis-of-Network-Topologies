...
def init_model(config, device=torch.device("cpu")):
    """
    Initializes a model, optimizer, and scheduler based on the given configuration.
    ...
    Returns:
        tuple: A tuple containing the initialized model, optimizer, and scheduler.
            The scheduler will be None if no gamma parameter is provided in config["optim"].
    """
    n_outs = {
        "none": [10, 10],
        "parity-digits": 10,
